 ...
 * Vosk/Service/Mp4Probe/Home/Reader/Nav/LargeFileMediaSourceFactory/DiskMirror/Decode/Chapters).
 ...
 */
enum class LogCat {
    PLAYBACK, SLEEP, LIBRARY, SCAN, DISK, DB, SETTINGS, WIDGET, SYNC, EBOOK, NET, BACKUP, THEME, UI, SYSTEM
}
